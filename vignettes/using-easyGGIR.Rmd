...
```{r, eval=FALSE}
combine_summary(filepath = "Output", part = 5)
# image of combined output
```

You can then save the result of this as a variable, e.g. `mydata <- combine_summary(...)` and then conduct your analysis in R. Alternatively you can make a new csv file with the output, e.g. `write.csv(mydata, file = "mydata.csv")`.
